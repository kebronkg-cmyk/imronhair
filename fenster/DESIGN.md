---
name: Irmonhair — Fassung „Fenster“ (Schleife mit eigener Handy-Komposition)
...
## Handy: eigene Komposition (Fassung /fenster/)
...
- Klebende Steuerleiste: Salon als Pillen, Länge als Chips. Ohne Wahl ist die Frage gold.
- `details.gruppe`: Nummer, Titel (1,7 rem, 300), Beschreibung, „ab …“ mit Anzahl, Plus → Kreuz. Offen klebt der Kopf unter der Steuerleiste.
- `.zeile`: Name (1,125 rem, 500, creme) links, Angaben (0,8 rem, still) darunter, Preis (1,125 rem, 500, gleich breite Ziffern) rechts. Keine Kästen, nur Haarlinien.
